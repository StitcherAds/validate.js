describe('validators.type', function() {
  const type = validate.validators.type.bind(validate.validators.type)
  ...
  afterEach(function() {
    ...
    delete validate.validators.type.messages.custom
  })
  ...
  it("allows you to customize the error message", function() {
    ...
    const options = { type: "object", message: "some other message %{attribute}" }
  ...
  it("allows functions as messages", function() {
    ...
    const options = { type: "object", message }
